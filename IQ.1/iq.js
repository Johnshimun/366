...
function newProblem(){
    if(currentProblem==10){
        ...
        document.getElementById(`answer1`).innerHTML = answer1[currentProblem-1];
        document.getElementById(`answer2`).innerHTML = answer2[currentProblem-1];
        document.getElementById(`answer3`).innerHTML = answer3[currentProblem-1];
        document.getElementById(`answer4`).innerHTML = answer4[currentProblem-1];
    }
}
