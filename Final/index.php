  ...
  session_start();
    ...
    switch($httpMethod) {
      ...
      case "GET":
        ...
        $whereSql = "
        SELECT * from page left outer JOIN login on login.id = page.id
        "; //  This is about archive and status not used in final
        
        // SELECT * from pages left outer JOIN login  WHERE status_id <> 0
      ...
      case 'POST':
        ...
        $whereSql = "
        INSERT INTO page(race_id, date, start_time, password, location)  VALUES (:race_id, :date, :start_time, :password, :location) 
        ";
