...
function createMeme($line1, $line2, $memeType) {
    // look up the category id for the chosen memeType
    ...
    // construct the proper SQL INSERT statement (including category id)
    ...
    // fetch the newly created meme from database JOINED with all the necessary category information
